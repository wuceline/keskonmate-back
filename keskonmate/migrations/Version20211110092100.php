...
final class Version20211110092100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_list (id INT AUTO_INCREMENT NOT NULL, series_id INT DEFAULT NULL, users_id INT DEFAULT NULL, season_nb INT DEFAULT NULL, series_nb INT DEFAULT NULL, episode_nb INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', type SMALLINT NOT NULL, INDEX IDX_3E49B4D15278319C (series_id), INDEX IDX_3E49B4D167B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
